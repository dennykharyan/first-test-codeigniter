                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="txtFirstName" class="form-control" value="<?= set_value('txtFirstName'); ?>">
                                <small class="form-text text-danger"><?= form_error('txtFirstName'); ?></small>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="txtLastName">Nama Belakang</label>
                                <input type="text" name="txtLastName" class="form-control" value="<?= set_value('txtLastName'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txtEmail" class="form-control" value="<?= set_value('txtEmail'); ?>">
                            <small class="form-text text-danger"><?= form_error('txtEmail'); ?></small>
                        </div>
                        
                        <div class="form-group">
                            <label for="txtPosition">Posisi</label>
                            <input type="text" name="txtPosition" class="form-control" value="<?= set_value('txtPosition'); ?>">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="txtJoinDate" class="form-control" value="<?= set_value('txtJoinDate'); ?>">
                                <small class="form-text text-danger"><?= form_error('txtJoinDate'); ?></small>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="txtPhone">No. Telepon</label>
                                <input type="text" name="txtPhone" class="form-control" value="<?= set_value('txtPhone'); ?>">
